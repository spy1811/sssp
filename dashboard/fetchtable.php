...
if (isset($_POST['request'])) {
    ...
    <?php
        ...
        $sql1 = "SELECT co.*, c.name, f.firm_name, b.branding as branding_name FROM customer_order co INNER JOIN ( SELECT id, name FROM customer ) c ON c.id = co.cname INNER JOIN firm f ON co.firm = f.id Inner Join branding b on co.branding=b.id where b.branding='$request'";
