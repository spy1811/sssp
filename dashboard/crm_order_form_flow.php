                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <?php
                                    ...
                                    $cid = $_SESSION['firm_id'];
                                    $q = "select id,firm_name from firm where id=$cid";
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <?php
                                    ...
                                    $brd=$_SESSION['branding_id'];
                                    /* echo $btype;
                                exit(); */
                                    $sql = "select * from branding where branding='$btype' && customer_name=$bid && id=$brd" ;
                                    ...
                                    /* $idd=$rt[0]; */
                                ?>
                                    <input type="text" class="form-control"  id="brand" value=" <?php echo   $bn . '(' . $wn . 'x' . $hn . 'x' . $gn . ')'; ?>" />
                                    <input type="hidden" name="branding" id="branding" value="<?php echo   $brandingId ; ?>"/>
